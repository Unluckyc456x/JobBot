...
# === СОЗДАЁМ ПРИЛОЖЕНИЕ FLASK ДЛЯ WEBHOOK ===
app = Flask(__name__)

@app.route('/webhook', methods=['POST'])
async def webhook():
    try:
        update = Update.model_validate(await request.get_json(), context=bot)
...
if __name__ == "__main__":
    ...
    async def set_webhook():
        ...
        webhook_url = f"https://{os.environ.get('RENDER_EXTERNAL_HOSTNAME', 'jobbot-gcjz.onrender.com')}/webhook"
